...
This Obsidian vault is an LLM-managed knowledge base for research on recursive media, reflexivity, and self-referentiality across media forms, following the Karpathy pattern. The LLM writes and maintains all wiki content. The human rarely edits directly.
...
For example: `## [2026-06-12] ingest | Stam — "Reflexivity in Film and Literature"`
...
- The Health Dashboard (`wiki/indexes/Health Dashboard.md`) tracks orphans, missing tags, and unresolved wikilinks
